		...
		<div id="bg">
			...
			<div id="in_lay">
				...
				<div id="in_con">
					...
					<div id="right">
						<div class="info">
							<div class="info_top"><h2>域名授权</h2></div>
							<table width="100%" cellspacing="0" cellpadding="5" border="0" bgcolor="#ffffff" align="center" class="cfBox">
								<tbody>
									...
									<th width="10%" class="buy_tr">域名</th>
                                    <th width="10%" class="buy_tr">IP</th>
									<th width="20%" class="buy_tr">QQ</th>
									<th width="20%" class="buy_tr">电话</th>
 ...
 ?>
									<?php 
										...
										if($result&&mysql_num_rows($result)){
											...
											echo "<td width='10%'' class='buy_tr'>".$row['ip']."</td>";
											echo "<td width='20%'' class='buy_tr'>".$row['qq']."</td>";
											echo "<td width='20%'' class='buy_tr'>".$row['tel']."</td>";
											echo "<td width='20%'' class='buy_tr'>".date("Y-m-d",$row['time'])."</td>";
